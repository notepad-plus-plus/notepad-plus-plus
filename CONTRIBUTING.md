...
***Ask not what npminmin can do for you - ask what you can do for npminmin***
...
1. Respect existing npminmin coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
...
![stay clean](https://github.com/ridermw/np-minus-minus/assets/images/good-bad-practice.jpg)
