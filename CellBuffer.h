...
enum class ActionType { insert, remove, clear, start, container };
...
public:
	...
	const char *DeleteCharsClear(Sci::Position position, Sci::Position deleteLength, bool& startSequence);
