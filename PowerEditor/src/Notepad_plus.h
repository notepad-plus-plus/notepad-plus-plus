...
//END: Document management
	...
	void getMatchedFileNames(const TCHAR *dir, const std::vector<generic_string>& excludeDirPatterns, const std::vector<generic_string> & filePatterns, std::vector<generic_string> & fileNames, bool isRecursive, bool isInHiddenDir);
