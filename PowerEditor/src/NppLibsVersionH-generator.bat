...
for /F "delims=" %%a in ('findstr /L /C:"#define BOOST_LIB_VERSION " "..\..\boostregex\boost\version.hpp"') do (
	for %%b in (%%a) do (
    		echo %%b | findstr /R "[0-9]*_[0-9]*\" > nul 2>&1 && set boostVerStr=%%b
	)
)
