...
void NppParameters::createXmlTreeFromGUIParams()
{
	...
	// <GUIConfig name="DarkMode" enable="no" colorTone="0" />
	{
		...
		GUIConfigElement->SetAttribute(L"darkToolBarIconSet", static_cast<int>(darkTbInfo._tbIconSet));
		...
		GUIConfigElement->SetAttribute(L"lightToolBarIconSet", static_cast<int>(lightTbInfo._tbIconSet));
