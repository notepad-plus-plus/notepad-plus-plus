...
{
	generic_string msg;
	generic_string defaultMessage = TEXT("Are you sure you want to save all documents?\r\rChoose \"Always Yes\" if your answer will always be \"Yes\" and you won't be asked this question again.\rYou can re-activate this dialog in Preferences dialog later.");
	NativeLangSpeaker* nativeLangSpeaker = NppParameters::getInstance().getNativeLangSpeaker();
