...
#define	IDD_FILEBROWSER_MENU		(IDD_FILEBROWSER + 10)
  ...
  #define IDM_FILEBROWSER_POWERSHELLHERE   (IDD_FILEBROWSER_MENU + 11)

#define	IDD_FILEBROWSER_CTRL		(IDD_FILEBROWSER + 30)
  #define	ID_FILEBROWSERTREEVIEW      (IDD_FILEBROWSER_CTRL + 1)
  #define	IDC_FILEBROWSER_FILTEREDIT  (IDD_FILEBROWSER_CTRL + 2)
  #define	ID_FILEBROWSERTREEVIEW_AUX  (IDD_FILEBROWSER_CTRL + 4)
