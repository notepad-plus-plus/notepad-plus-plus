...
#define IDC_PLUGINADM_DEACTIVATE (IDD_PLUGINSADMIN_DLG + 12)
#define IDC_PLUGINADM_ACTIVATE (IDD_PLUGINSADMIN_DLG + 13)
#define IDC_PLUGINADM_REMOVE_DISABLED (IDD_PLUGINSADMIN_DLG + 14)
#define IDC_PLUGINADM_REMOVE_INCOMPATIBLE (IDD_PLUGINSADMIN_DLG + 15)
