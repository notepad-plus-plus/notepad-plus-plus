...
#define	IDD_PREFERENCE_SUB_DATETIMEFORMAT 6170 //(IDD_PREFERENCE_BOX + 170)
	...
	#define	IDD_DATETIMEFORMAT_EXAMPLE_SRC_STATIC  (IDD_PREFERENCE_SUB_DATETIMEFORMAT + 6)
	#define	IDD_DATETIMEFORMAT_EXAMPLE_TGT_STATIC  (IDD_PREFERENCE_SUB_DATETIMEFORMAT + 7)
