...
#define IDD_PREFERENCE_SUB_DARKMODE 7100 //(IDD_PREFERENCE_BOX + 1100)
	...
	#define IDC_DARKMODE_TV_GB_STATIC (IDD_PREFERENCE_SUB_DARKMODE + 10)
	#define IDC_RADIO_DARKMODE_TVCLASSIC (IDD_PREFERENCE_SUB_DARKMODE + 11)
	#define IDC_RADIO_DARKMODE_TVLIGHT (IDD_PREFERENCE_SUB_DARKMODE + 12)
	#define IDC_RADIO_DARKMODE_TVDARK (IDD_PREFERENCE_SUB_DARKMODE + 13)
