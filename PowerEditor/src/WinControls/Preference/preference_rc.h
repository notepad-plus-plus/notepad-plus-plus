...
#define	IDD_PREFERENCE_SUB_EDITING 6200 //(IDD_PREFERENCE_BOX + 200)
	...
	#define	IDC_CHECK_COMMENTFOLDINGCPP (IDD_PREFERENCE_SUB_EDITING + 47)

	#define	IDC_GB_STATIC_CRLF (IDD_PREFERENCE_SUB_EDITING + 48)
	#define	IDC_RADIO_ROUNDCORNER_CRLF (IDD_PREFERENCE_SUB_EDITING + 49)
	#define	IDC_RADIO_PLEINTEXT_CRLF (IDD_PREFERENCE_SUB_EDITING + 50)
	#define	IDC_CHECK_WITHCUSTOMCOLOR_CRLF (IDD_PREFERENCE_SUB_EDITING + 51)
	#define	IDC_BUTTON_LAUNCHSTYLECONF_CRLF (IDD_PREFERENCE_SUB_EDITING + 52)
