...
#define	IDD_PREFERENCE_SUB_EDITING 6200 //(IDD_PREFERENCE_BOX + 200)
	...
	#define	IDC_GB_STATIC_NONPRINTCHAR (IDD_PREFERENCE_SUB_EDITING + 52)
	#define	IDC_BUTTON_NONPRINTCHAR_NOTE_TIP (IDD_PREFERENCE_SUB_EDITING + 53)
	#define	IDC_RADIO_NONPRINTCHAR_ABBREVIATION (IDD_PREFERENCE_SUB_EDITING + 54)
	#define	IDC_RADIO_NONPRINTCHAR_CODEPOINT (IDD_PREFERENCE_SUB_EDITING + 55)
	#define	IDC_BUTTON_NONPRINTCHAR_LIST_TIP1 (IDD_PREFERENCE_SUB_EDITING + 56)
	#define	IDC_BUTTON_NONPRINTCHAR_LIST_TIP2 (IDD_PREFERENCE_SUB_EDITING + 57)
