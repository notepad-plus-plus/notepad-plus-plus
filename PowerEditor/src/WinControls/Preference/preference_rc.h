...
#define	IDD_PREFERENCE_SUB_PANELIGNORESESSION 6180 //(IDD_PREFERENCE_BOX + 180)
	...
	#define	IDC_CHECK_CLIPBOARDHISTORY             (IDD_PREFERENCE_SUB_PANELIGNORESESSION + 2)
	#define	IDC_CHECK_DOCLIST                      (IDD_PREFERENCE_SUB_PANELIGNORESESSION + 3)
	#define	IDC_CHECK_CHARPANEL                    (IDD_PREFERENCE_SUB_PANELIGNORESESSION + 4)
	#define	IDC_CHECK_FILEBROWSER                  (IDD_PREFERENCE_SUB_PANELIGNORESESSION + 5)
	#define	IDC_CHECK_PROJECTPANEL                 (IDD_PREFERENCE_SUB_PANELIGNORESESSION + 6)
	#define	IDC_CHECK_DOCMAP                       (IDD_PREFERENCE_SUB_PANELIGNORESESSION + 7)
	#define	IDC_CHECK_FUNCLIST                     (IDD_PREFERENCE_SUB_PANELIGNORESESSION + 8)
	#define	IDC_CHECK_PLUGINPANEL                  (IDD_PREFERENCE_SUB_PANELIGNORESESSION + 9)
