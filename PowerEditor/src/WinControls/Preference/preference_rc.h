...
#define	IDD_PREFERENCE_SUB_LANGUAGE 6500 //(IDD_PREFERENCE_BOX + 500)
	...
	#define	IDC_INDENTSIZEVAL_STATIC (IDD_PREFERENCE_SUB_LANGUAGE + 13)
	#define	IDC_INDENTSIZEVAL_DISABLE_STATIC (IDD_PREFERENCE_SUB_LANGUAGE + 14)
	#define	IDC_INDENTSIZE_STATIC (IDD_PREFERENCE_SUB_LANGUAGE + 15)
