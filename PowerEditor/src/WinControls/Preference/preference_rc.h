...
#define	IDD_PREFERENCE_SUB_EDITING 6200 //(IDD_PREFERENCE_BOX + 200)
	...
	#define	IDC_CARETLINEFRAME_WIDTH_STATIC (IDD_PREFERENCE_SUB_EDITING + 46)
	#define	IDC_CARETLINEFRAME_WIDTH_SLIDER (IDD_PREFERENCE_SUB_EDITING + 47)
	#define	IDC_CARETLINEFRAME_WIDTH_DISPLAY (IDD_PREFERENCE_SUB_EDITING + 48)
