...
#define IDC_GB_STATIC_GLOBALREADONLYMODE               6524
#define IDC_RADIO_GLOBALREADONLYMODE_DISABLED          6525
#define IDC_RADIO_GLOBALREADONLYMODE_TOGGLEALLOWED     6526
#define IDC_RADIO_GLOBALREADONLYMODE_FORENSIC          6527
