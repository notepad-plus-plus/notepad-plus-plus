...
#define IDC_CHECK_PERFORMANCE_ENABLE                (IDD_PREFERENCE_SUB_PERFORMANCE + 2)
#define IDC_STATIC_PERFORMANCE_FILESIZE             (IDD_PREFERENCE_SUB_PERFORMANCE + 3)
#define IDC_EDIT_PERFORMANCE_FILESIZE               (IDD_PREFERENCE_SUB_PERFORMANCE + 4)
#define IDC_STATIC_PERFORMANCE_MB                   (IDD_PREFERENCE_SUB_PERFORMANCE + 5)
#define IDC_CHECK_PERFORMANCE_ALLOWBRACEMATCH       (IDD_PREFERENCE_SUB_PERFORMANCE + 6)
#define IDC_CHECK_PERFORMANCE_ALLOWAUTOCOMPLETION   (IDD_PREFERENCE_SUB_PERFORMANCE + 7)
#define IDC_CHECK_PERFORMANCE_ALLOWSMARTHILITE      (IDD_PREFERENCE_SUB_PERFORMANCE + 8)
#define IDC_CHECK_PERFORMANCE_ALLOWWORDWRAP         (IDD_PREFERENCE_SUB_PERFORMANCE + 9)
#define IDC_STATIC_PERFORMANCE_TIP                  (IDD_PREFERENCE_SUB_PERFORMANCE + 10)
