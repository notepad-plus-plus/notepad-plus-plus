...
#define	IDD_PREFERENCE_SUB_RECENTFILESHISTORY 6460 //(IDD_PREFERENCE_BOX + 400)
	#define IDC_MAXNBFILE_SEP_STATIC (IDD_PREFERENCE_SUB_RECENTFILESHISTORY + 1)
	#define IDC_EDIT_MAXNBFILEVAL (IDD_PREFERENCE_SUB_RECENTFILESHISTORY + 2)
	#define IDC_CUSTOMIZELENGTH_SEP_STATIC (IDD_PREFERENCE_SUB_RECENTFILESHISTORY + 3)
	#define IDC_EDIT_CUSTOMIZELENGTHVAL (IDD_PREFERENCE_SUB_RECENTFILESHISTORY + 4)
