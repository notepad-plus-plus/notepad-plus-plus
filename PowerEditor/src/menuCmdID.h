...
#define    IDM_SEARCH    (IDM + 3000)
    ...
    #define    IDM_SEARCH_MARKALLCASESENS          (IDM_SEARCH + 67)
    #define    IDM_SEARCH_MARKALLWHOLEWORD         (IDM_SEARCH + 68)
    #define    IDM_SEARCH_MARKALLCLASSICSETTINGS   (IDM_SEARCH + 69)
    #define    IDM_SEARCH_MARKALLUSEFINDSETTINGS   (IDM_SEARCH + 70)
