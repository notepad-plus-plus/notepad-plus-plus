...
//
#define NOTEPAD_PLUS_VERSION L"Notepad++ v8.7.1"

// should be X.Y : ie. if VERSION_DIGITALVALUE == 4, 7, 1, 0 , then X = 4, Y = 71
// ex : #define VERSION_VALUE L"5.63\0"
#define VERSION_INTERNAL_VALUE L"8.71\0"

#define VERSION_PRODUCT_VALUE L"8.7.1\0"
#define VERSION_DIGITALVALUE 8, 7, 1, 0
...
#define NOTEPADPLUS_USER_INTERNAL     (WM_USER + 0000)
	...
	#define NPPM_INTERNAL_INACTIVETABS_LAUNCHSTYLECONF  (NOTEPADPLUS_USER_INTERNAL + 107)
