...
#define NOTEPADPLUS_USER_INTERNAL     (WM_USER + 0000)
	...
	#define NPPM_INTERNAL_FINDREPLACESWAP               (NOTEPADPLUS_USER_INTERNAL + 77)
	#define NPPM_INTERNAL_FINDCOPYTOREPLACES            (NOTEPADPLUS_USER_INTERNAL + 78)
	#define NPPM_INTERNAL_REPLACESCOPYTOFIND            (NOTEPADPLUS_USER_INTERNAL + 79)
