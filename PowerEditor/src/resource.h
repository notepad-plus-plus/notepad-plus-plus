...
#define VERSION_INTERNAL_VALUE L"8.98\0"

#define VERSION_PRODUCT_VALUE L"8.9.8.0\0"
#define VERSION_DIGITALVALUE 8, 9, 8, 0
...
#define IDC_NETWORKPATHWARNINGTEXT_EDIT 1771
