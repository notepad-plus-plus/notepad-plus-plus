...
#define NOTEPADPLUS_USER_INTERNAL     (WM_USER + 0000)
	...
	// ::SendMessage(hwndNpp, NPPM_INTERNAL_RELOADNATIVELANG, BOOL notifyPlugins, 0);
	// if and only if notifyPlugins is TRUE, plugins will be notified of the user's new language preference.
