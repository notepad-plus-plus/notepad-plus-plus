...
[![Build status](https://ci.appveyor.com/api/projects/status/otytq928lct8uypu/branch/master?svg=true)](https://ci.appveyor.com/project/LordNyriox/notepad-plus-plus/branch/master)
